    ...
    <>
      {movie && (
        ...
        backgroundPosition: 'center',
          ...
          <div style={{backdropFilter: 'blur(3px)'}} className="mx-auto p-16 grid-cols-2 w-full flex justify-between sd:flex-wrap">
            ...
            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)' }} className="p-4 rounded-lg lg: max-w-8/12 md:w-2/3">
              <h1
              ...
              <p>
                ...
                <span style={{ color: "rgb(118, 171, 174)" }}>
                  {movie.release_date}
                </span>
              </p>
              <p>
              ...
              <p>
                ...
                <span style={{ color: "rgb(118, 171, 174)" }}>{ratings}</span>
              </p>
              <p>
                <span
                  style={{ color: "rgb(49, 54, 63)" }}
