  ...
  return (
    <nav className="bg-red-900 m-4 flex flex-wrap lg:flex-row justify-center lg:justify-between items-center rounded-xl">
      ...
      <div className="mt-4 lg:mt-2 m-2 flex flex-row items-center">
          <Link href="/" className="mx-2 p-2 text-slate-300">Home</Link>
          <Link href="/movies" className="mx-2 text-slate-300"> <MoviesMenu menuType="Movies" selectionMenu={moviesMenu}/> </Link>
          <div className='mx-2 text-slate-300'><GenresMenu menuType="Genres" selectionMenu={genresMenu} /></div>
          <Link href="/actors" className="mx-1 p-1 text-slate-300">Actors</Link>
      </div>
      <div className="mt-4 lg:mt-0 ml-2 relative pb-1 pr-2">
        <input className="p-2 pl-12 rounded-xl " type="text" name="search" placeholder="Search for movies..." />
