...
const MovieCards = ({ title, releaseYear, genre, poster }) => {
  return (
    <div
      style={{ borderColor: "rgb(118, 171, 174)g" }}
      className="flex flex-col bg-white shadow-md rounded-lg overflow-hidden my-4 w-56 sm:w-36 h-auto mx-2 border-solid border-2"
    >
      <div>
